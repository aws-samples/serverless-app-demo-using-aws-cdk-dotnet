...
namespace CdkServerlessApp
{
    public class CdkServerlessStack: Stack
    {
        internal CdkServerlessStack(Construct scope, string id, IStackProps props = null) : base(scope, id, props)
        {
            #region iamroles
